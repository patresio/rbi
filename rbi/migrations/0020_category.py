    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tn_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='rbi.category', verbose_name='Parent')),
            ],
            options={
